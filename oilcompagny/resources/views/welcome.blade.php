                ...
                <div id="contain-all" class=" slideout-panel">
                    ...
                    <section class="leaderboard-progress" style="padding: 0 10rem;">
                        <div class="contain text-center">
                            ...
                            <h2>Classement</h2>
                            <p class="lead">Fonctionnement : Chaque semaine une liste de 3 lots sera mise en place.<br>
                                Le Top 1 choisira en premier son lot, le Top 2 choisira parmi les lot restants, le Top 3 aura le lot restant.<br><br>

                                NB: Les points se gagne 1 à 1 en faisant des trajets dit "complet" (Camion+sac rempli)<br><br>
                            </p>
                            ...
                            <div class="ranking-table">
                                ...
                                <div class="ranking-table-row-leader-1">
                                    ...
                                    <div class="ranking-table-data">
                                        {{ array_keys($classements)[0] }}
                                    </div>
                                    <div class="ranking-table-data">
                                        <div>{{ array_values($classements)[0] }}</div>
                                    </div>
                                </div>
                                <div class="ranking-table-row-leader-2">
                                    ...
                                    <div class="ranking-table-data">
                                        {{ array_keys($classements)[1] }}
                                    </div>
                                    <div class="ranking-table-data">
                                        <div>{{ array_values($classements)[1] }}</div>
                                    </div>
                                </div>
                                <div class="ranking-table-row-leader-3">
                                    ...
                                    <div class="ranking-table-data">
                                        {{ array_keys($classements)[2] }}
                                    </div>
                                    <div class="ranking-table-data">
                                        <div>{{ array_values($classements)[2] }}</div>
{{--                                        <div class="complete"></div>--}}
                                    </div>
                                </div>

                                <?php unset($classements[array_keys($classements)[0]]); unset($classements[array_keys($classements)[0]]); unset($classements[array_keys($classements)[0]]); $i = 4; ?>
